    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/20 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-lg glass-panel rounded-3xl border border-cyan-500/40 shadow-2xl shadow-cyan-500/20 p-6 sm:p-8 text-left">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-slate-900">Tier 2 — Guided Deletion Flow</h2>
        ...
        <div className="space-y-3 mb-6">
          <div className="p-3.5 rounded-xl glass-card border border-slate-200/50 flex items-start space-x-3">
            ...
            <div>
              <p className="text-xs font-bold text-slate-900">Open Official Deletion Page</p>
              <p className="text-[11px] text-slate-600">Click below to launch {site.name}'s verified privacy settings page.</p>
              <a
                href={guidedUrl}
                target="_blank"
          ...
          <div className="p-3.5 rounded-xl glass-card border border-slate-200/50 flex items-start space-x-3">
            ...
            <div>
              <p className="text-xs font-bold text-slate-900">Log into Your Account</p>
              <p className="text-[11px] text-slate-600">Authenticate on {site.name} if prompted to verify account ownership.</p>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl glass-card border border-slate-200/50 flex items-start space-x-3">
            ...
            <div>
              <p className="text-xs font-bold text-slate-900">Submit Deletion Request & Log Proof</p>
              <p className="text-[11px] text-slate-600">Confirm request on site, then click below to add to PrivacyLens Request Tracker.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <button
            onClick={closeModal}
            className="w-1/3 py-2.5 rounded-xl glass-panel text-slate-700 font-semibold text-xs hover:bg-slate-100"
          >
            Cancel
          </button>
          <button
            onClick={handleConfirmInitiate}
            className="w-2/3 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-slate-900 font-bold text-xs shadow-lg shadow-cyan-600/30 transition-all flex items-center justify-center space-x-2"
          >
