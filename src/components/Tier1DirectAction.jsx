    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-lg glass-panel rounded-3xl border border-indigo-500/40 shadow-2xl shadow-indigo-500/20 p-6 sm:p-8 text-left">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold font-heading text-white">Tier 1 — Direct Partner Revocation</h2>
          ...
          <div>
            <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 mb-6">
              <div className="flex items-center justify-between text-xs mb-2">
                ...
                <span className="font-bold text-white font-mono">{site.name} ({site.domain})</span>
              </div>
              <div className="flex items-center justify-between text-xs mb-2">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="w-2/3 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs shadow-lg shadow-indigo-600/30 transition-all flex items-center justify-center space-x-2"
              >
        ...
        {step === 'EXECUTING' && (
          <div className="py-8 text-center">
            ...
            <h3 className="text-base font-bold text-white mb-2">Communicating with Partner API</h3>
            <div className="space-y-1.5 text-xs text-slate-400 max-w-xs mx-auto text-left font-mono">
        ...
        {step === 'DONE' && (
          <div className="text-center py-4">
            ...
            <h3 className="text-lg font-bold text-white mb-1">Revocation Executed!</h3>
